...
$(function(){  
    ...
    send_ajax_data(ajaxPostData, 
        function(data){
            ...
            // gpio
            if (data["data"].hasOwnProperty("gpio")) {
            ...
            // eeprom
            if (data["data"].hasOwnProperty("eeprom")) {
            ...
            // tmp75
            if (data["data"].hasOwnProperty("tmp75")) {
            ...
            // rtc
            if (data["data"].hasOwnProperty("rtc")) {
            ...
            // DB9_RS232 us100
            if (data["data"].hasOwnProperty("DB9_RS232")) {
                if (data["data"]["DB9_RS232"]["status"] == "ok") {
                    console.info($("#" + data["data"]["DB9_RS232"]["name"] + "_value")); 
                    $("#" + data["data"]["DB9_RS232"]["name"] + "_value").html(data["data"]["DB9_RS232"]["value"]); 
                    $("#" + data["data"]["DB9_RS232"]["name"] + "_status").attr("src", "img/ok.png");
                }
            }
            ...
            // usb SD1
            if (data["data"].hasOwnProperty("udisk")) {
                if (data["data"]["udisk"]["status"] == "ok") {
                    console.info(data["data"]["udisk"]["name"] + "_value"); 
                    $("#" + data["data"]["udisk"]["name"] + "_status").attr("src", "img/ok.png");
                }
            }

            // usb SD2
            // network1
            if (data["data"].hasOwnProperty("network1")) {
            ...
            // sdcard
            if (data["data"].hasOwnProperty("SDCard")) {
                if (data["data"]["SDCard"]["status"] == "ok") {
                    console.info(data["data"]["SDCard"]["name"] + "_value"); 
                    $("#" + data["data"]["SDCard"]["name"] + "_status").attr("src", "img/ok.png");
                }
            }
