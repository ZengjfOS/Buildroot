...
echo "copy image (:u-boot-imx6qsabresd_sd.imx"
cp u-boot.imx /media/sf_share/7112/IMX6_L4.1.15_2.0.0_MFG-TOOL/Profiles/Linux/OS\ Firmware/files/u-boot-imx6qsabresd_sd.imx
sync
sleep 1
echo "sync(:"
date
